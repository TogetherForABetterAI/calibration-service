...
class ReportBuilder:
    ...
    def build_report(self, y_test, probs):
        ...
        sns.set_style("white")  
        custom_cmap = LinearSegmentedColormap.from_list("custom_blue", ["#ffffff", "#34495e"])
        ...
        # Construir el PDF
        self.save_report(story) # Por ahora lo dejo así porque no tengo claro si el paquete UQM nos da y_test y y_pred parciales. De ser así, habría que modificarlo para que se llame al final de la evaluación.
