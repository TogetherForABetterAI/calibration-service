...
def setup_rabbitmq():
    ...
    middleware.bind_queue(queue_name=PROB_OUTPUTS_QUEUE_NAME, exchange_name=EXCHANGE_NAME)
    middleware.bind_queue(queue_name=DATA_INPUTS_QUEUE_NAME, exchange_name=EXCHANGE_NAME)
    return middleware
